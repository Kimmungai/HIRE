            ...
            function(data,status){
              ...
              for(count=0;count<messages_obj.length;count++)
              {
                ...
                if(messages_obj[count].user_id === {{Auth::id()}})
                {
                  ...
                  var message='<div class="incoming_msg" id="msg-serial-'+messages_obj[count].id+'"> <div class="incoming_msg_img"> <img src="{{url("/img/user-icon.png")}}" > </div><div class="received_msg"> <div class="received_withd_msg"> <p>'+messages_obj[count].message+'</p><span class="time_date"> '+human_date+'</span></div></div></div>';
                }
