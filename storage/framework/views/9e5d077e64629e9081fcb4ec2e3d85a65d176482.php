            ...
            function(data,status){
              ...
              for(count=0;count<messages_obj.length;count++)
              {
                ...
                if(messages_obj[count].user_id === <?php echo e(Auth::id()); ?>)
                {
                  ...
                  var message='<div class="incoming_msg" id="msg-serial-'+messages_obj[count].id+'"> <div class="incoming_msg_img"> <img src="<?php echo e(url("/img/car-icon.png")); ?>" > </div><div class="received_msg"> <div class="received_withd_msg"> <p>'+messages_obj[count].message+'</p><span class="time_date"> '+human_date+'</span></div></div></div>';
                }
    ...
    $.get("/check-messages",
          ...
          function(data,status){
            ...
            //  var list_item='<li id="item-'+data[count][1]+'"><a '+online_class+' href="#" onclick="open_company_chats('+data[count][1]+',\''+data[count][0]+'\','+online_status+')">'+data[count][0]+'<span class="unread">'+unread+'</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a></li>';
              ...
              var selected_chat_company='<div class="chat_list " id="item-'+data[count][1]+'" onclick="open_company_chats('+data[count][1]+',\''+data[count][0]+'\','+online_status+')"> <div class="chat_people"> <div class="chat_img"> <img src="<?php echo e(url("/img/car-icon.png")); ?>" > </div><div class="chat_ib"> <h5>'+data[count][0]+' <span id="new-msg-'+data[count][1]+'" class="badge unread">'+unread+'</span></h5></div></div></div>';
