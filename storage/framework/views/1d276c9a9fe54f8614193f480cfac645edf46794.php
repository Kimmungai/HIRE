                                ...
                                <tr>
                                    <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                        ...
                                        <h1 style="<?php echo e($style['header-1']); ?>">
                                            Hi <?php echo e($company->first_name); ?><?php echo e($company->last_name); ?>. A new order has been posted.
                                        </h1>
                                          ...
                                          <tr>
                                            <td align="center" valign="top">
                                              <table border="1" cellpadding="20" cellspacing="0" width="600" id="emailContainer">
                                                <tr>
                                                 <td>Order title:</td><td><strong><?php echo e($order->order_name); ?></strong></td>
                                                </tr>
                                                <tr>
                                                 <td>Pick up date:</td><td><strong><?php echo e($order->pick_up_date); ?></strong></td>
                                                </tr>
                                              </table>
                                            </td>
                                          </tr>
                                            ...
                                            <table style="<?php echo e($style['body_action']); ?>" align="center" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="center">
                                                        ...
                                                        <a href="<?php echo e(url('company_order_view/'.$order->id)); ?>"
