  ...
  $(document).ready(function(){
    ...
    $.get("/check-messages",
          ...
          function(data,status){
            ...
            {
              var list_item='<li><a class="on" href="#" onclick="open_company_chats('+data[count][1]+')">'+data[count][0]+'<span class="unread">2</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a></li>';
              $('#company-list').append(list_item);
            }

    });
    }
    function open_company_chats(id)
    {
      ...
      $.get("/retrieve-messages/",
            ...
            function(data,status){
              ...
              for(count=0;count<data.length;count++)
              {
                var message='<article class="to"> <div class="date">'+data[count][1]+'</div><p>'+data[count][0]+'</p> </article>';
                $('#company_title').html(data[count][2]);
