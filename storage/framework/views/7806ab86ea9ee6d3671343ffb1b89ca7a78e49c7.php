                                ...
                                <tr>
                                    <td style="<?php echo e($fontFamily); ?> <?php echo e($style['email-body_cell']); ?>">
                                        ...
                                        <h1 style="<?php echo e($style['header-1']); ?>">
                                            You have a new message from <?php echo e($user->company_name); ?>:
                                        </h1>
                                        ...
                                        <!-- Action Button -->
                                            ...
                                            <table style="<?php echo e($style['body_action']); ?>" align="center" width="100%" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                  <td>Sender</td><td><?php echo e($user->first_name); ?></td>
                                                </tr>
                                                <tr>
                                                  <td>Message</td><td><?php echo e(}}</td>
                                                </tr>
                                            </table>
                                            ...
                                            <!-- Intro -->
                                                ...
                                                <p style="{{ $style['paragraph']); ?>">
                                                    click on the link below to reply。
                                                </p>
