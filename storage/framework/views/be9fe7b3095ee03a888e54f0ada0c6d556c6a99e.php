          ...
          <?php $__env->startSection('content'); ?>
                    ...
                    <?php if($errors->has('hire_comp')): ?>
                    <p class="validation-errors"><?php echo e($errors->first('hire_comp')); ?></p>
                    <?php endif; ?>
                    ...
                    <?php if($errors->has('hire_comp_fu')): ?>
                    <p class="validation-errors"><?php echo e($errors->first('hire_comp_fu')); ?></p>
                    <?php endif; ?>
                    ...
                    <?php if($errors->has('hire_last_name')): ?>
                    <p class="validation-errors"><?php echo e($errors->first('hire_last_name')); ?></p>
                    <?php endif; ?>
                      </div>
                    ...
                    <?php if($errors->has('hire_first_name')): ?>
                    <p class="validation-errors"><?php echo e($errors->first('hire_first_name')); ?></p>
                    <?php endif; ?>
                      </div>
                    ...
                    <?php if($errors->has('hire_last_name_fu')): ?>
                    <p class="validation-errors"><?php echo e($errors->first('hire_last_name_fu')); ?></p>
                    <?php endif; ?>
                      </div>
                    ...
                    <?php if($errors->has('hire_first_name_fu')): ?>
                    <p class="validation-errors"><?php echo e($errors->first('hire_first_name_fu')); ?></p>
                    <?php endif; ?>
                      </div>
                      <!-- zip code -->
                  <div class="full" ng-class="{
              ...
              住所は文字、数字とハイフンのみご入力ください。
                ...
                <p class="validation-errors"><?php echo e($errors->first('zip')); ?></p>
                <?php endif; ?>
                  </div>
                          <!-- Address -->
                      <div class="full" ng-class="{
                    ...
                    <?php if($errors->has('hire_address')): ?>
                    <p class="validation-errors"><?php echo e($errors->first('hire_address')); ?></p>
                    <?php endif; ?>
                    ...
                    <?php if($errors->has('hire_tel')): ?>
                    <p class="validation-errors"><?php echo e($errors->first('hire_tel')); ?></p>
                    <?php endif; ?>
                  ...
                  <p class="validation-errors"><?php echo e($errors->first('email')); ?></p>
                  <?php endif; ?>
                    ...
                    <?php if($errors->has('hire_email_check')): ?>
                    <p class="validation-errors"><?php echo e($errors->first('hire_email_check')); ?></p>
                    <?php endif; ?>
                      ...
                      <?php if(count($errors)): ?>
                        ...
                        <span class="hidden" ng-init="formModel.hire_comp_fu='<?php echo e(old('hire_comp_fu')); ?>'"></span>
                        <span class="hidden" ng-init="formModel.hire_last_name='<?php echo e(old('hire_last_name')); ?>'"></span>
                        <span class="hidden" ng-init="formModel.hire_first_name='<?php echo e(old('hire_first_name')); ?>'"></span>
                        <span class="hidden" ng-init="formModel.hire_last_name_fu='<?php echo e(old('hire_last_name_fu')); ?>'"></span>
                        <span class="hidden" ng-init="formModel.hire_first_name_fu='<?php echo e(old('hire_first_name_fu')); ?>'"></span>
                        <span class="hidden" ng-init="formModel.zip='<?php echo e(old('zip')); ?>'"></span>
                        <span class="hidden" ng-init="formModel.hire_address='<?php echo e(old('hire_address')); ?>'"></span>
                        <span class="hidden" ng-init="formModel.hire_tel='<?php echo e(old('hire_tel')); ?>'"></span>
                        <span class="hidden" ng-init="formModel.email='<?php echo e(old('email')); ?>'"></span>
                        <span class="hidden" ng-init="formModel.hire_email_check='<?php echo e(old('hire_email_check')); ?>'"></span>
                      <?php endif; ?>
                      </form>
                  </div>
                </div>
