    ...
    <nav>
        ...
        <div class="container">
            ...
            <ul class="topnav" id="myTopnav">
                <li><a href="{{url('/')}}" target="_blank"><img class="logo" src="http://hiremitsumori.com/img/logo.png"></a></li>
        ...
        <nav class="nav-second">
            ...
            　<li>
                    ...
                    @if(Auth::user())
                      <a href="#" class="toggle" ><i class="fa fa-user" aria-hidden="true"></i>{{Auth::user()->company_name}}<i class="fa fa-caret-down" aria-hidden="true"></i></a>
                    @else
