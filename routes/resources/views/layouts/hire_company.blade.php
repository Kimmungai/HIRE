...
<nav class="nav-second">
  ...
  <div class="chat">
      ...
      <div class="chat-open">
          ...
          <header><a class="back" href="#" id="back_company_list"><i class="fa fa-chevron-left" aria-hidden="true"></i></a> <h5 id="company_title" class="on"></h5> <a href="#" class="pull-right close"><i class="fa fa-times" aria-hidden="true"></i></a></header>
